...
<div class="row">
    <div class="col-12 col-md-9">   
        <p class="text-container-title">Conectado a la sala <strong>EXAMPLE 1</strong></p>
        <div class="messages-container">
            <div class="message">
                ...
                <div>
                    <p class="message-user">User example 1</p>
                    <p class="message-body">Message example</p>
                </div>
                <small class="message-time">Enviado hace 1 min</small>
            </div>
        </div>
    ...
    <div class="col-12 col-md-3 d-none d-md-block">
        ...
        <div class="users-container">
            ...
            <div class="user">
                <div class="avatar-group">
                    <div class="avatar-image">
                        <img src="{{ asset('images/avatar.jpg') }}" class="has-profile-image" alt="Profile avatar">
                    </div>
                    <p class="m-0">User Example 1</p>
                </div>
                <div class="badge-user-status"></div>
